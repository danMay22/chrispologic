...
export function CoverDemo() {
  return (
    <div className='bg-[url(/banner.jpg)] object-contain overflow-hidden  rounded-[6px] top-5 sticky md:mx-auto z-50 xl:w-4/5 2xl:w-[68%]s flex item-center justify-between py-6 px-4 md:px-8 mx-6'>
