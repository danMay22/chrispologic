...
export function CoverDemo() {
  return (
    <div className='bg-[url(/banner.jpg)] object-contain overflow-hidden top-5 md:mx-auto xl:w-4/5 2xl:w-[68%] py-6 px-4 md:px-8 mx-6 rounded-xl shadow-[0_35px_35px_rgba(0,0,0,0.35)]'>
